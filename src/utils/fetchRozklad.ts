...
export async function fetchRozklad(id: number, html: string): Promise<any> {
            ...
            .each((_, tr) => {
                ...
                $(tr)
                    ...
                    .each((tdKey, td) => {
                        checkDayInData(
                            data,
                            new WeekDay(tdKey, weekNumber).stringName(),
                        );
